    ...
    a.fn.hsMenu = function (b) {
        ...
        return this.each(function () {
            ...
            a('.menu-trigger').click(function () {
                a(this).toggleClass('ripple-out');
                a(this).find('span.toggle-nav').toggleClass('active');
                document.body.classList.toggle('no-scroll');
                a('.site-overlay').toggleClass('visible');
            ...
            if (c.outClickToClose == true) {
                a(window).click(function (l) {
                    ...
                    a('span.toggle-nav').removeClass('active');
                    document.body.classList.remove('no-scroll');
                    a('.site-overlay').removeClass('visible');
                    a(j).fadeOut()
                })
            }

            a('i.toggle-nav').click(function () {
                a('.user-penal, .grid-items, .user-info').fadeOut().removeClass('fadeInUp');
                a(g).removeClass('open');
                a('span.toggle-nav').removeClass('active');
                document.body.classList.remove('no-scroll');
            ...
            a('.its-parent').click(function () {
                a(this).siblings('.its-children').toggle();
                a(this).toggleClass('downed');
                if (a('.its-children.second-level-menu').css('display') == 'block'){
                    a('.nav-footer-menu').addClass('hidden')
                } else {
                    a('.nav-footer-menu').removeClass('hidden')
                }
            });
            function e() {
